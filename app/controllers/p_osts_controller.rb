class POstsController < ApplicationController
  before_action :set_p_ost, only: %i[ show edit update destroy ]

  # GET /p_osts or /p_osts.json
  def index
    @p_osts = POst.all
  end

  # GET /p_osts/1 or /p_osts/1.json
  def show
  end
  ...
  # PATCH/PUT /p_osts/1 or /p_osts/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /p_osts/1 or /p_osts/1.json
  def destroy
    @p_ost.destroy
    respond_to do |format|
  ...
  private
    ...
    def p_ost_params
      params.require(:p_ost).permit(:content)
    end
end
